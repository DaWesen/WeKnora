export default {
  ...
  pluginManagement: {
    navLabel: '插件管理',
    title: '外部插件',
    description: '查看部署级外部插件的运行状态、受控审计记录和失败恢复操作。',
    refresh: '刷新',
    loading: '正在加载…',
    retry: '重试',
    empty: '尚未发现外部插件。',
    ...
    audit: '审计',
    restart: '重启',
    restartConfirm: '确定重启插件“{name}”吗？该操作仍会受到重启预算和退避策略限制。',
    restartSuccess: '插件“{name}”已重启。',
    restartFailed: '重启插件失败。',
    restartBudget: '重启预算',
    restartBudgetUsage: '已使用 {attempts}/{maxAttempts}，剩余 {remaining}',
    restartBudgetExhausted: '重启预算已耗尽',
    restartInProgress: '重启中',
    restartBackoff: '退避 {milliseconds} ms',
    healthMonitoringTitle: '健康监测',
    healthMonitoring: '监测中',
    healthMonitorStopped: '未监测',
    healthInterval: '每 {seconds} 秒检查',
    healthTimeout: '超时 {seconds} 秒',
    healthFailureProgress: '连续失败 {failures}/{threshold}',
    healthLastChecked: '最近检查：{time}',
    healthLastFailure: '最近失败：{time}',
    loadFailed: '加载插件列表失败。',
