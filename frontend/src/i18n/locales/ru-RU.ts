export default {
  ...
  pluginManagement: {
    navLabel: 'Управление плагинами',
    title: 'Внешние плагины',
    description: 'Просматривайте состояние внешних плагинов уровня развёртывания, очищенные записи аудита и действия восстановления.',
    refresh: 'Обновить',
    loading: 'Загрузка…',
    retry: 'Повторить',
    empty: 'Внешние плагины не обнаружены.',
    name: 'Плагин',
    version: 'Версия',
    type: 'Тип',
    status: 'Статус',
    ...
    restartConfirm: 'Перезапустить плагин «{name}»? Ограничения бюджета и задержки перезапуска сохраняются.',
    restartSuccess: 'Плагин «{name}» перезапущен.',
    restartFailed: 'Не удалось перезапустить плагин.',
    restartBudget: 'Бюджет перезапуска',
    restartBudgetUsage: 'Использовано {attempts}/{maxAttempts}, осталось {remaining}',
    restartBudgetExhausted: 'Бюджет перезапуска исчерпан',
    restartInProgress: 'Перезапуск',
    restartBackoff: 'Задержка {milliseconds} мс',
    healthMonitoringTitle: 'Проверка работоспособности',
    healthMonitoring: 'Мониторинг',
    healthMonitorStopped: 'Не отслеживается',
    healthInterval: 'Проверка каждые {seconds} с',
    healthTimeout: 'Тайм-аут {seconds} с',
    healthFailureProgress: 'Последовательные сбои {failures}/{threshold}',
    healthLastChecked: 'Последняя проверка: {time}',
    healthLastFailure: 'Последний сбой: {time}',
