export default {
  ...
  pluginManagement: {
    navLabel: '플러그인 관리',
    title: '외부 플러그인',
    description: '배포 수준 외부 플러그인의 상태, 정제된 감사 기록 및 장애 복구 작업을 확인합니다.',
    refresh: '새로 고침',
    loading: '불러오는 중…',
    retry: '다시 시도',
    empty: '발견된 외부 플러그인이 없습니다.',
    name: '플러그인',
    version: '버전',
    type: '유형',
    status: '상태',
    ...
    audit: '감사',
    restart: '다시 시작',
    restartConfirm: '플러그인 “{name}”을(를) 다시 시작할까요? 재시작 예산과 백오프 정책은 계속 적용됩니다.',
    restartSuccess: '플러그인 “{name}”을(를) 다시 시작했습니다.',
    restartFailed: '플러그인을 다시 시작하지 못했습니다.',
    restartBudget: '재시작 예산',
    restartBudgetUsage: '{attempts}/{maxAttempts}회 사용, {remaining}회 남음',
    restartBudgetExhausted: '재시작 예산 소진',
    restartInProgress: '재시작 중',
    restartBackoff: '백오프 {milliseconds} ms',
    healthMonitoringTitle: '상태 모니터링',
    healthMonitoring: '모니터링 중',
    healthMonitorStopped: '모니터링 안 함',
    healthInterval: '{seconds}초마다 확인',
    healthTimeout: '시간 초과 {seconds}초',
    healthFailureProgress: '연속 실패 {failures}/{threshold}',
    healthLastChecked: '최근 확인: {time}',
    healthLastFailure: '최근 실패: {time}',
