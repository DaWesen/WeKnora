export default {
  ...
  pluginManagement: {
    navLabel: 'Plugin Management',
    title: 'External Plugins',
    description: 'View deployment-level external plugin status, sanitized audit records, and failure recovery actions.',
    refresh: 'Refresh',
    loading: 'Loading…',
    retry: 'Retry',
    empty: 'No external plugins have been discovered.',
    name: 'Plugin',
    version: 'Version',
    type: 'Type',
    status: 'Status',
    ...
    audit: 'Audit',
    restart: 'Restart',
    restartConfirm: 'Restart plugin “{name}”? Restart budgets and backoff policies still apply.',
    restartSuccess: 'Plugin “{name}” restarted.',
    restartFailed: 'Failed to restart plugin.',
    restartBudget: 'Restart budget',
    restartBudgetUsage: '{attempts}/{maxAttempts} used, {remaining} remaining',
    restartBudgetExhausted: 'Restart budget exhausted',
    restartInProgress: 'Restarting',
    restartBackoff: 'Backoff {milliseconds} ms',
    healthMonitoringTitle: 'Health monitoring',
    healthMonitoring: 'Monitoring',
    healthMonitorStopped: 'Not monitoring',
    healthInterval: 'Check every {seconds}s',
    healthTimeout: 'Timeout {seconds}s',
    healthFailureProgress: 'Consecutive failures {failures}/{threshold}',
    healthLastChecked: 'Last checked: {time}',
    healthLastFailure: 'Last failure: {time}',
